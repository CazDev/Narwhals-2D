...
using TMPro;
	...
	public class P2_PlayerHealth : MonoBehaviour
	{
		static P2_PlayerHealth instance;
		public static P2_PlayerHealth Instance { get { return instance; } }
		...
		void Awake ()
		{
			...
			instance = GetComponent<P2_PlayerHealth>();
		}
